<div class="row">
    ...
    <div id="content" class="grid_9 right">
        ...
        <div>
            <h2 style="color: #000000;"><?php if (isset($meta))  {echo $meta;}?></h2>
            ...
            if (!empty($cat))
                ...
                foreach($cat as $art):
                    ...
                    <div style="margin-left: 20px; display: inline-block;">
                        <a href="<?php echo URL::site($art['id'].'/'.$str);?>"><img width="150px" height="200px" alt="<?=$art['title'];?>" src="/media/img/<?=$art['img'];?>"></a>
                        <div style="font-weight: bold; font-size: 15px;"><a href="<?php echo URL::site($art['id'].'/'.$str);?>"><?=$art['title'];?></a></div>
                    </div>



                    <?php endforeach;  else echo "<h1 align='center' style='color:#7f0000'>Информация по запросу не найдена</h1>";?>
        </div>
