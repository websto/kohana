...
<div id="tab1" > <!--  Start of Tab 1 -->
    ...
    <div class="ae-widget">
        <table id="pagetable" ><!--  Start of Table -->
            ...
            <tbody><?php  foreach($slider as $art): ?>

            <tr><td><?//=$art['title'];?></td>
                <td align="center">
                    <a id="<?=$art['id'];?>" href="#" rel="creat_new_category">
                        <img width="50px" height="50px" src="<?php echo URL::base(); ?>media/img/slider/<?=$art['path'];?>" alt="edit" title="Изменить"/></a>

                </td>
                <td align="center">
                    <a href="/admin_leks/main/slider_edit/<?=$art['id'];?>">
                        <img class='img_ic' src="<?php echo URL::base(); ?>media/admin/css/icons/edit.png" alt="edit" title="Изменить"/></a>

                </td>
                <td align="center"> <form method="post" action="/admin_leks/slider/delete">
    ...
    <div class="creat_category" style="background: #fff;">
        ...
        <form method="post" enctype="multipart/form-data" action="/admin_leks/slider/img">
...
<div> <!--  Start of Tab 2 -->
    ...
    <h4 align="center">Добавить</h4>
    <form method="post" action="/admin_leks/slider/new" enctype="multipart/form-data">
        ...
        <label for="small">Ссылка</label>
        <input name="href" type="text" class="small ui-corner-all" id="small" />
