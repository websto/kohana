...
<div class="ae-widget">
            ...
            function generate_menu($cat_menu, $level)
            {
...

                {
                    ...
                    echo "<form method='post' action='/admin_leks/categ/delete'><input type='hidden' name='id' value='$id'> <input onclick='return confirm(\"Вы уверены?\")' type='image' src='/media/admin/css/i/del.png'></form>";
                    echo "</td>";
                    echo "</tr></table>";
        ...
        <div class="creat_category" style="background: #fff;">
            <div class="popwindow">
               ...
               <form method="post" action="/admin_leks/categ/home" enctype="multipart/form-data">
            <table border="1" style="font-weight: bold;font-size: 16px;">
                ...
                <tr>
                    <td>Meta_description:</td><td><input type="text" name="meta_d"/></td>
                </tr>
                <tr>
                    <td>Meta_keywords:</td><td><input type="text" name="meta_k"/></td>
                </tr>

                <tr>
                    <td>Фильтры сортировки:</td><td>
        ...
        <div class="edit_category" style="background:#ffffff;">
            ...
            <form method="post" action="/admin_leks/categ/edit">
            <table border="1">
                ...
                <tr>
                    <td>Meta_d:</td><td><input type="text" name="meta_d"/></td>
                </tr>
                <tr>
                    <td>Meta_k:</td><td><input type="text" name="meta_k"/></td>
                </tr>
                <tr>
                    <td colspan="3" style="height:40px; text-align:right;">
                        <input type="submit" name="submit" value="Сохранить"  class="button"/>
