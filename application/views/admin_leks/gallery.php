...
<div id="tab1" > <!--  Start of Tab 1 -->
    ...
    <div class="ae-widget">
        <table id="pagetable" ><!--  Start of Table -->
            <thead><tr><th>Name</th><th>Image</th><th>Delete</th></tr></thead>
            ...
            <tr><td><?=$art['title'];?></td>
                ...
                <td align="center">
                    <a id="<?=$art['id'];?>" href="#" rel="creat_new_category">
                        <img width="50px" height="50px" src="<?php echo URL::base(); ?>media/img/gallery/<?=$art['path'];?>" alt="edit" title="Изменить"/></a>

                </td>

                <td align="center"> <form method="post" action="/admin_leks/gallery/delete">
    ...
    <div class="creat_category" style="background: #fff;">
        ...
        <form method="post" enctype="multipart/form-data" action="/admin_leks/gallery/img">
...
<div> <!--  Start of Tab 2 -->
    ...
    <h4 align="center">Добавить фото</h4>
    <form method="post" action="/admin_leks/gallery/new" enctype="multipart/form-data">


        <label for="medium">Название</label>
        <input name="title" type="text" class="medium ui-corner-all" id="medium"/>
        <label for="medium">Описание</label>
        <textarea name="desc" rows="5" cols="42"></textarea>
